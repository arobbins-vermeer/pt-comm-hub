...
export function getSortedPostsData() {
  ...
  const allPostsData = axwayFilesData.concat(azureFilesData).concat(cloudflareFilesData).concat(githubFilesData).concat(jenkinsFilesData).concat(netiqFilesData).concat(sonarqubeFilesData).concat(vmwareFilesData).concat(miscellaneousFilesData);
...
export function getAllPostIds() {
  ...
  const fileNames = axwayFileNames.concat(azureFileNames).concat(cloudflareFileNames).concat(githubFileNames).concat(jenkinsFileNames).concat(netiqFileNames).concat(sonarqubeFileNames).concat(vmwareFileNames).concat(miscellaneousFileNames);
